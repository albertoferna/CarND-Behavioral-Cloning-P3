...
used_samples = read_data(data_folder, 100, 250)
...
saving = ModelCheckpoint('AlexNet.{epoch:02d}-{val_loss:.2f}.h5', save_best_only=True)
model.fit(X_train, y_train, batch_size=128, validation_split=0.3, shuffle=True, nb_epoch=12, callbacks=[saving])
